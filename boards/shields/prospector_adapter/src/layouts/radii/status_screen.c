...
lv_obj_t *zmk_display_status_screen() {
    ...
    lv_obj_set_size(left_panel, 160, 172);
    ...
    lv_obj_set_pos(zmk_widget_layer_indicator_obj(&layer_indicator_widget), 6, 12);
    ...
    lv_obj_align(zmk_widget_modifier_indicator_obj(&modifier_indicator_widget), LV_ALIGN_BOTTOM_RIGHT, -8, -8);

    zmk_widget_battery_circles_init(&battery_circles_widget, screen);
    lv_obj_set_pos(zmk_widget_battery_circles_obj(&battery_circles_widget), 160, 110);
